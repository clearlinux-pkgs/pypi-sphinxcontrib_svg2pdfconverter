...
Source0  : https://files.pythonhosted.org/packages/ad/4c/950e1196838dc92b4e98b8a734fa2181e793310078ff80e7440a5d6a59b9/sphinxcontrib-svg2pdfconverter-1.2.2.tar.gz
...
%prep
%setup -q -n sphinxcontrib-svg2pdfconverter-1.2.2
cd %{_builddir}/sphinxcontrib-svg2pdfconverter-1.2.2
pushd ..
cp -a sphinxcontrib-svg2pdfconverter-1.2.2 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1719258087
...
cp %{_builddir}/sphinxcontrib-svg2pdfconverter-%{version}/LICENSE.txt %{buildroot}/usr/share/package-licenses/pypi-sphinxcontrib_svg2pdfconverter/f56fe1edc266f2bcc71696f7f941e03323aa915d || :
